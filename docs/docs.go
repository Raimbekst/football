    ...
    "paths": {
        ...
        "/auth/user": {
            ...
            "put": {
                ...
                "parameters": [
                    {
                        "description": "a user update info",
                        "name": "data",
                        "in": "body",
                        "required": true,
                        "schema": {
        ...
        "/card/{id}": {
            ...
            "put": {
                ...
                "parameters": [
                    ...
                    {
                        "description": "foot card input",
                        "name": "data",
                        "in": "body",
                        "required": true,
                        "schema": {
                            "$ref": "#/definitions/v1.UpdateCard"
                        }
                    }
                ],
                "responses": {
        ...
        "/order/times": {
            "get": {
                ...
                "operationId": "get-all-order-times",
                "parameters": [
                    {
                        "type": "integer",
                        "name": "limit",
                ...
                "parameters": [
                    {
                        ...
                        "required": true,
                        "schema": {
                            "$ref": "#/definitions/v1.FootService"
                        }
                    }
                ],
                "responses": {
        ...
        "/service/{id}": {
            "get": {
                ...
                "responses": {
                    "200": {
                        "description": "OK",
                        "schema": {
                            "$ref": "#/definitions/domain.FootService"
                        }
                    },
                    "400": {
                        "description": "Bad Request",
            ...
            "put": {
                ...
                "parameters": [
                    ...
                    {
                        "description": "foot service input",
                        "name": "data",
                        "in": "body",
                        "required": true,
                        "schema": {
                            "$ref": "#/definitions/v1.UpdateFootService"
                        }
                    }
                ],
                "responses": {
